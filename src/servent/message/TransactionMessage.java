...
public class TransactionMessage extends BasicMessage {
	...
	public TransactionMessage(ServentInfo sender, ServentInfo receiver, int amount, BitcakeManager bitcakeManager, int initiatorId, int snapshotNo) {
		super(MessageType.TRANSACTION, sender, receiver, String.valueOf(amount), initiatorId, snapshotNo);
