...
public class AppConfig {
	...
	public volatile static AtomicBoolean collectingInfo = new AtomicBoolean(false);

	/**
	 * Info for all about current snapshot initiator
	 */
	public static SnapshotPair snapshotInfo = new SnapshotPair(-1, 0);
	...
	public static void readConfig(String configName) {
		...
		/**
		 * Nije trazeno, ali radi lakseg pokretanja vise servenata od jednom dodato - citanje iz bootstrap servera
		 */
		for (int i = 0; i < serventCount; i++) {
			...
			ServentInfo newInfo = new ServentInfo("localhost", i, serventPort, new CopyOnWriteArrayList<>());
